...
import com.example.miniprojectandroid.databinding.ActivityEedBinding;
import com.example.miniprojectandroid.databinding.EedDescBinding;

public class EedActivity extends AppCompatActivity {

    private ActivityEedBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEedBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        //course name - tukar ikut department
        String[] programTitles = getResources().getStringArray(R.array.eed_course);

        //course description - tukar ikut department
        String[] programDescriptions = getResources().getStringArray(R.array.eed_desc);
    ...
    private void addExpandableItem(String title, String description) {
        ...
        EedDescBinding itemBinding = EedDescBinding.inflate(inflater, binding.expandableListContainer, false);
        ...
        binding.checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //go to med activity
                Intent checkerIntent = new Intent(EedActivity.this, CheckerActivity.class);
