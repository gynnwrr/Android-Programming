...
import com.example.miniprojectandroid.databinding.ActivityCidBinding;
import com.example.miniprojectandroid.databinding.CidDescBinding;

public class CidActivity extends AppCompatActivity {

    private ActivityCidBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCidBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        //course name - tukar ikut department
        String[] programTitles = getResources().getStringArray(R.array.cid_course);

        //course description - tukar ikut department
        String[] programDescriptions = getResources().getStringArray(R.array.cid_desc);
    ...
    private void addExpandableItem(String title, String description) {
        ...
        CidDescBinding itemBinding = CidDescBinding.inflate(inflater, binding.expandableListContainer, false);
        ...
        binding.checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //go to med activity
                Intent checkerIntent = new Intent(CidActivity.this, CheckerActivity.class);
